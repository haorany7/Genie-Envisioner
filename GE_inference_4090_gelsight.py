...
# --- GE 模型配置 ---
GE_CONFIG = "configs/ltx_model/task_USB_expert/action_model_task_USB_expert_gelsight_deployment.yaml"
# 使用 USB expert 的权重
GE_WEIGHTS = "checkpoints/task_USB_expert_gelsight_action/step_20000/diffusion_pytorch_model.safetensors"
DOMAIN_NAME = "task_usb_expert" # 对应 stats.json 中的前缀
NUM_INFERENCE_STEPS = 10  # 采样步数，越大越准但越慢
PROMPT = "unplug the USB"  # 任务描述: "plug in the USB" 或 "unplug the USB"
