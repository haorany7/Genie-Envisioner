#!/bin/bash
#SBATCH --job-name="calvin_tactile_eef_zscore_abs_action_chunk_18"
#SBATCH --output="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_eef_zscore_abs_action_chunk_18/slurm-%j.out"
#SBATCH --error="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_eef_zscore_abs_action_chunk_18/slurm-%j.err"
...
# 📌 Environment Setup
# ============================================================================
echo "🚀 Starting CALVIN Tactile EEF Z-Score Absolute Policy Training (Action Chunk 18) at $(date)"
echo "============================================================================"
...
CONFIG_FILE="${PROJ_ROOT}/configs/ltx_model/policy_model_calvin_tactile_eef_zscore_absolute_action_chunk_18.yaml"
...
SLURM_OUT_DIR="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_eef_zscore_abs_action_chunk_18"
