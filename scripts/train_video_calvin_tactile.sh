#!/bin/bash
#SBATCH --job-name="calvin_tactile_video_action_chunk_27"
#SBATCH --output="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_27/slurm-%j.out"
#SBATCH --error="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_27/slurm-%j.err"
...
# 📌 Environment Setup
# ============================================================================
echo "🚀 Starting CALVIN Tactile Video Training (Action Chunk 27) at $(date)"
echo "============================================================================"
...
CONFIG_FILE="${PROJ_ROOT}/configs/ltx_model/video_model_lerobot_calvin_tactile.yaml"
...
SLURM_OUT_DIR="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_27"
