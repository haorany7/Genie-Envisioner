...
CONFIG_PATH="${PROJ_ROOT}/configs/ltx_model/video_model_infer_fast_calvin.yaml"
...
OUTPUT_DIR="${OUTPUT_DIR:-/projects/behe/haorany7/WORLD-MODEL-TOUCH/outputs/calvin_infer/$(date +%Y%m%d_%H%M%S)}"
