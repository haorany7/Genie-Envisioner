#!/bin/bash
#SBATCH --job-name="calvin_tactile_video_action_chunk_18"
#SBATCH --output="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_18/slurm-%j.out"
#SBATCH --error="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_18/slurm-%j.err"
...
# 📌 Environment Setup
# ============================================================================
echo "🚀 Starting CALVIN Tactile Video Training (Action Chunk 18) at $(date)"
echo "============================================================================"
...
CONFIG_FILE="${PROJ_ROOT}/configs/ltx_model/video_model_lerobot_calvin_tactile_action_chunk_18.yaml"
...
SLURM_OUT_DIR="/work/hdd/bche/haorany7/WORLD-MODEL-TOUCH/slurm_outputs/calvin_tactile_video_action_chunk_18"
mkdir -p "${SLURM_OUT_DIR}"

echo "============================================================================"
echo "🔥 Launching video training on ${NGPU} GPU(s)..."
echo "============================================================================"
...
echo "============================================================================"
echo "✅ Video training launched. Check logs and checkpoints under the configured output_dir."
echo "✅ Video training completed at $(date)"
echo "============================================================================"
